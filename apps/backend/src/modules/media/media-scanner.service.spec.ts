...
describe('MediaScannerService.reconcileShows', () => {
  ...
  function build(
    ...
    const duplicates = { pruneOrphanedGroups: jest.fn(async () => 0) };
    const svc = new MediaScannerService(
      prisma as any, {} as any, {} as any, {} as any, showDuplicates as any, duplicates as any, resolver as any,
    );
    return { svc, prisma, upserts, deletes, itemUpdates, showDuplicates, duplicates, resolver };
  }
