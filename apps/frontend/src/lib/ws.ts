...
export interface WsEventMap {
  ...
  [WS_EVENTS.IMDB_DATASET_DOWNLOAD_STARTED]: ImdbEventPayload;
  [WS_EVENTS.IMDB_DATASET_DOWNLOAD_PROGRESS]: ImdbEventPayload;
  [WS_EVENTS.IMDB_DATASET_DOWNLOAD_COMPLETED]: ImdbEventPayload;
  [WS_EVENTS.IMDB_DATASET_DOWNLOAD_FAILED]: ImdbEventPayload;
