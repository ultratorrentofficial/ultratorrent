...
export const PERMISSIONS = {
  ...
  TORRENT_SCHEDULER_OVERRIDE: 'torrent_scheduler.override',
  ...
  // RSS TV-show airing-status awareness
  RSS_SHOW_STATUS_LOOKUP: 'rss.show_status.lookup',
  RSS_SHOW_STATUS_REFRESH: 'rss.show_status.refresh',
  ...
  // Subtitle Intelligence (core) — the definitive subtitle acquisition,
  // validation, and synchronization engine.
  SUBTITLE_INTELLIGENCE_VIEW: 'subtitle_intelligence.view',
  SUBTITLE_INTELLIGENCE_SEARCH: 'subtitle_intelligence.search',
  SUBTITLE_INTELLIGENCE_DOWNLOAD: 'subtitle_intelligence.download',
  SUBTITLE_INTELLIGENCE_SYNCHRONIZE: 'subtitle_intelligence.synchronize',
  SUBTITLE_INTELLIGENCE_MANAGE: 'subtitle_intelligence.manage',
...
export const ROLE_PERMISSIONS: Record<SystemRole, Permission[]> = {
  ...
  [SystemRole.POWER_USER]: [
    ...
    PERMISSIONS.SUBTITLE_INTELLIGENCE_DOWNLOAD,
    PERMISSIONS.SUBTITLE_INTELLIGENCE_SYNCHRONIZE,
