...
| Date | Change |
|------|--------|
| 2026-07-06 | **Media Items grouped TV browser — larger posters + smaller default page.** `SeriesGroupedList` show posters enlarged (`h-14 w-10` → `h-24 w-16`, 2:3) and the default page size dropped 30 → 10 shows per page (`SERIES_PAGE_SIZE`). |
