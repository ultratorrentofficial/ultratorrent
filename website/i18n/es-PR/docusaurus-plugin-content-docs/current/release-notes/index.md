...
Cada versión publicada, la más reciente primero. Esta página muestra las **25 más recientes** de **213** versiones; el historial completo está en [CHANGELOG.md](https://github.com/ultratorrentofficial/ultratorrent/blob/main/CHANGELOG.md).
...
Etiquetada [`v0.87.0`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.87.0).
...
Etiquetada [`v0.86.2`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.86.2).
...
Etiquetada [`v0.86.1`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.86.1).
...
Etiquetada [`v0.86.0`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.86.0).
...
Etiquetada [`v0.85.10`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.85.10).
...
Etiquetada [`v0.85.9`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.85.9).
...
Etiquetada [`v0.85.8`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.85.8).
...
Etiquetada [`v0.85.7`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.85.7).
...
Etiquetada [`v0.85.6`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.85.6).
...
Etiquetada [`v0.85.5`](https://github.com/ultratorrentofficial/ultratorrent/releases/tag/v0.85.5).
