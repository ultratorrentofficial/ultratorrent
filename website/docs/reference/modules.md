...
graph LR
  ...
  "rbac" --> "module_registry"
  "auth" --> "media_manager"
  "files" --> "media_manager"
  "auth" --> "release_scoring"
  "rss" --> "release_scoring"
  "auth" --> "media_acquisition_intelligence"
  "rbac" --> "media_acquisition_intelligence"
  "module_registry" --> "media_acquisition_intelligence"
  "audit" --> "media_acquisition_intelligence"
  "notifications" --> "media_acquisition_intelligence"
  "settings" --> "media_acquisition_intelligence"
  "rss" --> "media_acquisition_intelligence"
  "automation" --> "media_acquisition_intelligence"
  "release_scoring" --> "media_acquisition_intelligence"
  "auth" --> "media_server_analytics"
  "rbac" --> "media_server_analytics"
  "module_registry" --> "media_server_analytics"
  "audit" --> "media_server_analytics"
  "notifications" --> "media_server_analytics"
  "settings" --> "media_server_analytics"
  "media_manager" --> "media_server_analytics"
  "automation" --> "media_server_analytics"
  "auth" --> "notification_center"
  "rbac" --> "notification_center"
  "module_registry" --> "notification_center"
  "audit" --> "notification_center"
  "settings" --> "notification_center"
```
