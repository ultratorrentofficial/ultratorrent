...
| [UTCONSOLE.md](docs/UTCONSOLE.md) | **UltraTorrent Console** — the read-only terminal client: install, the nine views, `console.view` and RBAC, the live event stream, how it stays cheap on the server it watches, and the colour/`TERM` trap |
